...
class RestaurantsUpdateManyInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RestaurantsUpdateManyInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RestaurantsUpdateManyInput:
        """Create an instance of RestaurantsUpdateManyInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RestaurantsUpdateManyInput.parse_obj(obj)

        _obj = RestaurantsUpdateManyInput.parse_obj({

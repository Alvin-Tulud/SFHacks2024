...
class RestaurantsCreateManyInput(BaseModel):
    """
    RestaurantsCreateManyInput
    """
    about: StrictStr = Field(...)
    name: StrictStr = Field(...)
    rating: Union[StrictFloat, StrictInt] = Field(...)
    reviews: Optional[RestaurantsCreateInputReviews] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RestaurantsCreateManyInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RestaurantsCreateManyInput:
        """Create an instance of RestaurantsCreateManyInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RestaurantsCreateManyInput.parse_obj(obj)

        _obj = RestaurantsCreateManyInput.parse_obj({
            "about": obj.get("about"),
            "name": obj.get("name"),
            "rating": obj.get("rating"),
            "reviews": RestaurantsCreateInputReviews.from_dict(obj.get("reviews")) if obj.get("reviews") is not None else None
        })
        return _obj

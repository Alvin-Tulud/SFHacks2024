...
class StringWithAggregatesFilter(BaseModel):
    ...
    __properties = ["_count", "_max", "_min", "contains", "endsWith", "eq", "equals", "gt", "gte", "in", "lt", "lte", "mode", "not", "notIn", "search", "startsWith"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StringWithAggregatesFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StringWithAggregatesFilter:
        """Create an instance of StringWithAggregatesFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StringWithAggregatesFilter.parse_obj(obj)

        _obj = StringWithAggregatesFilter.parse_obj({

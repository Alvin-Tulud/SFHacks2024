...
class NestedIntFilter(BaseModel):
    ...
    equals: Optional[StrictInt] = None
    gt: Optional[StrictInt] = None
    gte: Optional[StrictInt] = None
    var_in: Optional[conlist(StrictInt)] = Field(None, alias="in")
    lt: Optional[StrictInt] = None
    lte: Optional[StrictInt] = None
    var_not: Optional[NestedIntFilterNot] = Field(None, alias="not")
    not_in: Optional[conlist(StrictInt)] = Field(None, alias="notIn")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NestedIntFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NestedIntFilter:
        """Create an instance of NestedIntFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NestedIntFilter.parse_obj(obj)

        _obj = NestedIntFilter.parse_obj({
            "eq": obj.get("eq"),
            ...
            "lt": obj.get("lt"),
            "lte": obj.get("lte"),
            "var_not": NestedIntFilterNot.from_dict(obj.get("not")) if obj.get("not") is not None else None,
            "not_in": obj.get("notIn")
        })
        return _obj

from neurelo.models.nested_int_filter_not import NestedIntFilterNot
NestedIntFilter.update_forward_refs()

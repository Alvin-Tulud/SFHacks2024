...
class FloatWithAggregatesFilter(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FloatWithAggregatesFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FloatWithAggregatesFilter:
        """Create an instance of FloatWithAggregatesFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FloatWithAggregatesFilter.parse_obj(obj)

        _obj = FloatWithAggregatesFilter.parse_obj({

...
class NestedFloatFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NestedFloatFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NestedFloatFilter:
        """Create an instance of NestedFloatFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NestedFloatFilter.parse_obj(obj)

        _obj = NestedFloatFilter.parse_obj({
            "eq": obj.get("eq"),
...
NestedFloatFilter.update_forward_refs()

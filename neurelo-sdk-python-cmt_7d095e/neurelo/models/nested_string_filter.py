...
class NestedStringFilter(BaseModel):
    ...
    __properties = ["contains", "endsWith", "eq", "equals", "gt", "gte", "in", "lt", "lte", "not", "notIn", "search", "startsWith"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NestedStringFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NestedStringFilter:
        """Create an instance of NestedStringFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NestedStringFilter.parse_obj(obj)

        _obj = NestedStringFilter.parse_obj({
...
NestedStringFilter.update_forward_refs()
